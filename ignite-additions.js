...
(function initPlanPeek() {
  ...
  const PLANS = {
    foundation: {
      ...
      items: [
        { device: 'mac', title: 'Responsive Website', desc: 'A fast, mobile-first website built from a niche-tested snapshot, with your reviews, services and booking built in from day one.', img: './images/plan-website.jpg', video: '' },
        { device: 'phone', title: 'Google Reviews Funnel', desc: 'The moment a job is done, your customer gets a text with a one-tap link to leave a Google review.', img: './images/plan-reviews-funnel.jpg', video: '' },
        { device: 'phone', title: 'Missed-Call Text Back', desc: 'Miss a call and the caller gets an instant text, so the lead never goes cold while you are on a job.', img: './images/plan-missed-call.jpg', video: '' },
        { device: 'phone', title: 'AI Booking System', desc: 'Customers book straight onto your real calendar through a conversation, with no back-and-forth.', img: './images/plan-booking.jpg', video: '' },
      ],
      creatives: [],
    },
    growth: {
      ...
      items: [
        { device: 'phone', title: 'Google Reviews Funnel', desc: 'Automated review requests after every job so your rating keeps climbing on its own.', img: './images/plan-reviews-funnel.jpg', video: '' },
        { device: 'phone', title: 'Missed-Call Text Back', desc: 'Instant text replies to every missed call, 24/7.', img: './images/plan-missed-call.jpg', video: '' },
        { device: 'phone', title: 'AI Booking System', desc: 'Conversational AI that qualifies the enquiry and books the job directly onto your calendar.', img: './images/plan-booking.jpg', video: '' },
      ],
      creatives: ['./images/creative-1.jpg', './images/creative-2.jpg', './images/creative-3.jpg'],
    ...
    ads: {
      ...
      items: [],
      creatives: ['./images/ad-sample-1.jpg'],
